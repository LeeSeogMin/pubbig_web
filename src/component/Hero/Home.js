            ...
            <section className="hero" id="home">
                <div className="container f_flex top">
                    <div className="left top">
                        ...
                        <h3>
                            한신 공빅학부는 인문사회학적 지식을 바탕으로 데이터
                            분석역량을 갖춘 <b>문과출신</b>의 융복합형
                            미래인재를 위해 신설되었습니다.
                            <b>수학을 잘 몰라도, 컴퓨터를 잘 몰라도</b> 누구나
                            데이터에 생명을 불어넣고 가치있는 정보를 만드는
                            융합형 데이터 전문가가 될 수 있습니다. 한신
                            공빅학부는 여러분에게 다양한 가능성을 제공하고자
                            합니다.
                        </h3>
                        <br />
                        <h3>
                            공적정신과 공공문제 해결 역량을 겸비한 공무원,
                            공기업, 시민단체 등 공공분야로 진출하거나 융합적
                            사고와 빅데이터분석 역량을 바탕으로 공기업과
                            민간기업의 데이터분석가로 취업할 수 있습니다.
                        </h3>
                        <br />
                        <h3>
                            빅데이터와 AI시대에 공빅학부에서 새로운 융합형
                            인재가 되는 기회를 갖기 바랍니다. 한신 공빅학부가
                            여러분을 기다리고 있습니다.
                        </h3>
                    </div>
                    <div className="right">
